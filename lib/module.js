...
function Typo3(options) {
  options = _merge(_options, this.options.typo3)
  ...
  this.options.router.middleware.push('context')

  // add i18n plugin
  this.addPlugin({
    src: resolve(__dirname, './templates/plugins/i18n.js'),
    options,
    fileName: join('typo3', 'plugins.i18n.js')
  })
